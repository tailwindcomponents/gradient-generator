<template>
    <div class="bg-gray-100">
        <div class="container flex flex-col items-center px-4 py-6 mx-auto space-y-6 lg:space-y-0 lg:flex-row lg:justify-between">
            ...
            <p class="text-sm text-center text-gray-500">&copy; {{ new Date().getFullYear() }} Highscore Studio. Component copyrights belongs to their authors.</p>

            <div class="flex items-center space-x-6">
                <a href="/privacy" class="text-sm text-gray-500 transition-colors duration-300 hover:underline hover:text-primary">Privacy</a>
                <a href="/legal" class="text-sm text-gray-500 transition-colors duration-300 hover:underline hover:text-primary">Legal</a>
                <a href="/cookies" class="text-sm text-gray-500 transition-colors duration-300 hover:underline hover:text-primary">Cookies</a>
                ...
                <a href="https://github.com/tailwindcomponents" target="_blink" class="text-gray-500 transition-colors duration-300 hover:text-primary">
